...
export default {
  ...
  data: function () {
    return {
      ...
      icon: util.icon,
      // showRecipe: false,
      // item: { name: Object.keys(this.dataItem)[0], quantity: Object.values(this.dataItem)[1] },
    };
  },
  computed: {
  ...
  methods: {
    ...
    // TODO: refactor the following inventory methods into 1 with an additional action param
